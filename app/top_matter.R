      ...
      column(width = 10,
        ...
        column(5,
          ...
          p("Read the original March 21 article: ", a("Medium article", .noWS = "outside",
            href = "https://medium.com/@covind_19/predictions-and-role-of-interventions-for-covid-19-outbreak-in-india-52903e2544e6")),
          p("Read the accompanying April 3 article: ", a("Medium article", .noWS = "outside",
            href = "https://medium.com/@covind_19/historic-lockdown-prediction-models-to-study-lockdown-effects-and-the-role-of-data-in-the-crisis-a0afeeec5a6")),
