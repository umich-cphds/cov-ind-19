metrics <- tabPanel("Metrics",
                    fluidRow(column(width = 1),
                             column(width = 10,
                                    ...
                                    hr(),
                                    plotOutput("India_pforest_cfr1", height = "500px"),
                                    hr(),
                                    plotOutput("India_pforest_dbl", height = "500px"),
                                    hr(),
                                    plotOutput("India_pforest_r_est", height = "500px"),
                                    hr(),
                                    plotOutput("India_pforest_tp", height = "500px"),
                                    hr(),
