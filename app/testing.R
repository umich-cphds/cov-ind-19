testing <- tabPanel("Testing",
                     ...
                     fluidRow(column(width = 1),
                              column(width = 10,
                                     ...
                                     hr(),
                                     h2("Daily confirmed positive tests and total tests across countries"),
                                     p("This figure provides the number of COVID-19 tests (light green) and positive tests (red) over location and time. Data source: api.covid19india.org."),
