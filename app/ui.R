...
You can click on countries in the legend to add or remove them and you cann hover your cursor over the lines to see the exact numerical counts."),
        ...
        #                     plotlyOutput("India_p4a_full", height = "600px"),
        ...
        #                     plotlyOutput("India_p4b_full", height = "600px"),
        #                     hr(),
        ...
        #                   h2("Quick adherence (one-week delay)"),
        #                   h3("Figure 4a (please note that the y-axis is in log base-10 scale; hover over the bars for count estimates and upper credible limits)"),
        #                   plotlyOutput("India_p4a_fulldl", height = "600px"),
        #                   h2("Slow adherence (two-week delay)"),
        #                   h3("Figure 4b (please note that the y-axis is in log base-10 scale; hover over the bars for count estimates and upper credible limits)"),
        #                   plotlyOutput("India_p4b_fulldl", height = "600px"),
        #                   hr(),
        #                   h2("Longer term forecasts post-lockdown"),
        #                   p("We present four hypothetical scenarios:",
        #                     tags$ul(
        ...
        #                   h2("Quick adherence (one-week delay)"),
        #                   h3("Figure 5a"),
        #                   plotlyOutput("India_p5adl", height = "600px"),
        #                   h3("Figure 5b"),
        #                   plotlyOutput("India_p5bdl", height = "600px"),
        #                   hr(),
        #                   h2("Slow adherence (two-week delay)"),
        #                   h3("Figure 6a"),
        #                   plotlyOutput("India_p6adl", height = "600px"),
        #                   h3("Figure 6b"),
        #                   plotlyOutput("India_p6bdl", height = "600px"),
        #                   hr()
        #                 )
        #               )),
        ...
        #                   h2("Quick adherence (one-week delay)"),
        #                   h3("Figure 4a (please note that the y-axis is in log base-10 scale; hover over the bars for count estimates and upper credible limits)"),
        #                   plotlyOutput("India_p4a_fullmh", height = "600px"),
        #                   h2("Slow adherence (two-week delay)"),
        #                   h3("Figure 4b (please note that the y-axis is in log base-10 scale; hover over the bars for count estimates and upper credible limits)"),
        #                   plotlyOutput("India_p4b_fullmh", height = "600px"),
        #                   hr(),
        #                   h2("Longer term forecasts post-lockdown"),
        #                   p("We present four hypothetical scenarios:",
        #                     tags$ul(
        ...
        #                   h2("Quick adherence (one-week delay)"),
        #                   h3("Figure 5a"),
        #                   plotlyOutput("India_p5amh", height = "600px"),
        #                   h3("Figure 5b"),
        #                   plotlyOutput("India_p5bmh", height = "600px"),
        #                   hr(),
        #                   h2("Slow adherence (two-week delay)"),
        #                   h3("Figure 6a"),
        #                   plotlyOutput("India_p6amh", height = "600px"),
        #                   h3("Figure 6b"),
        #                   plotlyOutput("India_p6bmh", height = "600px"),
        #                   hr()
        #                 )
        #               )),
        #      tabPanel("Kerala",
        ...
        #                   h2("Quick adherence (one-week delay)"),
        #                   h3("Figure 4a (please note that the y-axis is in log base-10 scale; hover over the bars for count estimates and upper credible limits)"),
        #                   plotlyOutput("India_p4a_fullkl", height = "600px"),
        #                   h2("Slow adherence (two-week delay)"),
        #                   h3("Figure 4b (please note that the y-axis is in log base-10 scale; hover over the bars for count estimates and upper credible limits)"),
        #                   plotlyOutput("India_p4b_fullkl", height = "600px"),
        #                   hr(),
        #                   h2("Longer term forecasts post-lockdown"),
        #                   p("We present four hypothetical scenarios:",
        #                     tags$ul(
        ...
        #                   h2("Quick adherence (one-week delay)"),
        #                   h3("Figure 5a"),
        #                   plotlyOutput("India_p5akl", height = "600px"),
        #                   h3("Figure 5b"),
        #                   plotlyOutput("India_p5bkl", height = "600px"),
        #                   hr(),
        #                   h2("Slow adherence (two-week delay)"),
        #                   h3("Figure 6a"),
        #                   plotlyOutput("India_p6akl", height = "600px"),
        #                   h3("Figure 6b"),
        #                   plotlyOutput("India_p6bkl", height = "600px"),
        #                   hr()
        #                 )
        #               ))
  )
