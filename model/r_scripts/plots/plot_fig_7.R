...
data_caseplot = 
  data_caseplot %>%
  mutate(full2 = full)
ggplot(data = data_caseplot, aes(x = Date, y = dailyCases, group = full)) + 
...
data_deathplot = 
  data_deathplot %>%
  mutate(full2 = full)
ggplot(data = data_deathplot, aes(x = Date, y = dailyDeaths, group = full)) + 
...
# culumative
ggplot(data = data_deathplot, aes(x = Date, y = Deaths, group = full)) + 
