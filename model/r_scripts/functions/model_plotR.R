model_plotR <- function(Result = NULL, mcmc_pars = NULL, T_predict = NULL, T_simu = NULL, n_period, data,
                        data_test = NULL, data_initial, call, save_plots = save_plot, trace_plot.common_axis = FALSE, model = "Multinomial", ...){
  ...
  if(call == "estimateR"){
    ...
    if(save_plots == TRUE)
      ggsave("trace_plot.png", trace_plot, width = 15, height = 12, dpi = 300)
